...
unless defined?(ABAQUS_ELEMENT_SPRING1_RB)
  ABAQUS_ELEMENT_SPRING1_RB = true

  require 'abaqus/element_base'

  class Abaqus::Element::Spring1 < Abaqus::Element
    def initialize(i,n1)
      @nodes = [n1]
      @i = i
      assign(@i,self)
    ...
    Abaqus::Element::BasicElementMap << [/SPRING1/,self]
  end
end
...
if $0 == __FILE__
  ...
  class TestElementMASS < Test::Unit::TestCase
    def setup
      @eid = 3
      @nids = [4]
      @e = Abaqus::Element.new("Spring1",@eid, *@nids)
    end
    def teardown
